...
const StudentView = ({ courseId }) => {
  ...
  const handleMessageStudent = (student) => {
    if (student && student.id && student.first_name && student.last_name) {
      navigation.navigate('Chat', {
        partnerId: student.id,
        partnerName: student.first_name + ' ' + student.last_name,
        partnerAvatar: student.avatar || null
      });
    } else {
      alert('Không thể nhắn tin: thông tin sinh viên không hợp lệ.');
    }
  };
